AFRAME.registerComponent("creat_markers", {
    init: async function(){
        ...
        dishes.map(dish =>{
            ...
            mainPlane.setAttribute("id", `main-plane_${dish.id}`)
            ...
            titlePlane.setAttribute("id", `title-plane_${dish.id}`)
            ...
            model.setAttribute("id", `model_${dish.id}`)
            model.setAttribute("position", dish.model_geometry.position)
            model.setAttribute("rotation", dish.model_geometry.rotation)
            model.setAttribute("sclae", dish.model_geometry.scale)
    ...
    getDishes: async function(){
        ...
        .get()
        .then(snail =>{
            return snail.docs.map(doc => doc.data())
        })
    }
})